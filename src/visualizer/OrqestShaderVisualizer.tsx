...
export type OrqestShaderKind = 'above-clouds' | 'luminous-mist' | 'liquid-earth' | 'molten' | 'apparition';
...
const palettes: Record<OrqestShaderKind, Record<'light'|'dark', Palette>> = {
  'above-clouds': { light:['#eaf3ff','#5f97f4','#b2d3ff','#c4aaff'], dark:['#111b2f','#5da0ff','#97ddff','#b48fff'] },
...
const variants: Record<OrqestShaderKind, number> = {'above-clouds':0,'luminous-mist':1,'liquid-earth':2,molten:3,apparition:4};
